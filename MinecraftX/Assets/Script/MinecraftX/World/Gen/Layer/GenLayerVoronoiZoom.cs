...
public class GenLayerVoronoZoom : GenLayer {

	public GenLayerVoronoZoom(long seed, GenLayer parentGenLayer) : base(seed)
	{
	...
	public override int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
	{
		...
		{
			System.Array.Copy(aint1, (l3 + (areaY & 3)) * i1 + (areaX & 3), aint2, l3 * areaWidth, areaWidth);
		}
